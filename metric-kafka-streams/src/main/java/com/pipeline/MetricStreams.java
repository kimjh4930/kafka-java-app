...
public class MetricStreams {
    ...
    public static void main(final String[] args) {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "metric-streamsapplication");
        ...
        KStream<String, String> filteredCpuMetric = metricBranch[0]
                .filter((key, value) -> MetricJsonUtils.getTotalCpuPercent
                        (value) > 0.5);
        filteredCpuMetric.mapValues(value -> MetricJsonUtils.
                getHostTimestamp(value)).to("metric.cpu.alert");
