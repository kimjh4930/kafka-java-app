...
public class ElasticSearchSinkConnectorConfig extends AbstractConfig {
    ...
    public static ConfigDef CONFIG = new ConfigDef()
            ...
            .define(ES_CLUSTER_PORT, ConfigDef.Type.INT, ES_CLUSTER_PORT_DEFAULT_VALUE,
                    ConfigDef.Importance.HIGH, ES_CLUSTER_PORT_DOC)
            .define(ES_INDEX, ConfigDef.Type.STRING, ES_INDEX_DEFAULT_VALUE, ConfigDef.Importance.
                    HIGH, ES_INDEX_DOC);
